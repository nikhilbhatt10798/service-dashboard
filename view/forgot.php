...
<body>
    <div class="container-login100">
        <div id="boader">
            ...
            <div class="emailForm" style="display: block;">
                <div>
                    <h1> foget password </h1>
                </div>
                <div>
                    <div id="inputDiv">
                        <input type="email" autocomplete="off" id="email" placeholder="Enter Email"><i class="fa fa-user-circle-o"></i>
                    </div>
                    <div id="buttonDiv"><button class="button" onclick="emailSubmit()" id='ebutton'>submit</button></div>
                </div>
            </div>
        ...
        <div>
            <a href="route.php?param=index">Back </a>
        </div>
    </div>
    </div>
    <script>
        ...
        $('#' + "email").focus(function() {
            $(".fa.fa-user-circle-o").css("color", "blue");
        });
        $('#' + "email").focusout(function() {
            $(".fa.fa-user-circle-o").css("color", "black");
        });
        //::::::::::::::::for new pass
        ...
        function emailSubmit(){
           ...
           var email= document.getElementById('email').value;
        //    console.log(email);
        //    console.log(eamildiv);
        //    console.log(newpassDiv);
           $.ajax({
               type:"post",
               url:"route.php?param=emailCheck",
               ...
               if(data==email){
                ...
                // $('#result').html(data);
                $('#result').html("Email Exist check mail to confirm and Reset Password");
                // $('#result').css({"color": "#da163a","font-size": "38px","font-weight": "700","font-family": "cursive"});
               }else{
                // $('#result').html(data);
                $('#result').html("Email doesn't Exist Signup First");
               }
